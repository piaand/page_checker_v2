...
/**
 * Class provides a simple timer that keeps track of time elapsed in performing
...
public class Timer {
    ...
    public void logPerformanceTime(double time) {
        logger.info("It took " + time + " milliseconds to perform the request.");
    }
